...
import 'package:scholarsync/journal.dart' as journal_lib;
import 'reminders.dart' as reminders_lib;
import 'package:scholarsync/appointments.dart' as appointments_lib;
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  static const _storageKey = 'scholarsync_appointments';
...
Future<void> _loadTodaysReminders() async {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('ScholarSync', style: TextStyle(color: Color(0xFF1A1A1A), fontWeight: FontWeight.bold)),
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Row(children: [
              const Expanded(child: Text("Welcome to ScholarSync", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold))),
            ...
            Row(
              children: [
                ElevatedButton.icon(
                  ...
                  onPressed: () => _logActivity('Study session logged', 'You logged your first study session', Icons.menu_book, Colors.amber),
                ...
                ElevatedButton.icon(
                  ...
                  onPressed: () => _logActivity('Assignment completed', 'You completed your first assignment', Icons.assignment_turned_in, Colors.green),
                  style: ElevatedButton.styleFrom(backgroundColor: const Color(0xFF5A5A4D)),
                ),
                  const SizedBox(width: 12),
                  ElevatedButton.icon(
