              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Text(
                      'OR',
                      style: TextStyle(color: _greyTextColor.withAlpha((0.6 * 255).round())), 
                    ),
                    const SizedBox(height: 12),
                    ...
                    SizedBox(
                      ...
                      child: OutlinedButton.icon(
                        ...
                        icon: Icon(Icons.fingerprint, size: 24, color: _auraPrimaryColor),
                        label: Text(
                          'Use Biometric Authentication',
                          style: TextStyle(fontSize: 16, color: _auraPrimaryColor),
                        ),
                    ...
                    TextButton(
                      onPressed: () {
                        // Navigate to Forgot Passphrase screen
                      },
                      child: Text(
                        'Forgot your passphrase?',
